<?php include 'component/header.php'; ?>
    ...
    <section class="new-product py-5">
        <div class="container" style="font-family: Macondo; color: #814603;">
            <h2 class="text-center mb-4">Baju Wanita</h2>
            ...
            <div class="row g-4">
                ...
                <div class="col-md-3 col-sm-6 product-card" data-category="dress">
                    <a href="detail.php" class="text-dark text-decoration-none"><img src="assets/images/2.png" alt="Product Image" class="img-fluid"></a>
                    <h5 class="mt-2">Laras Dress</h5>
                    <p><span class="product-price">Rp. 120,000</span></p>
                </div>
                <div class="col-md-3 col-sm-6 product-card" data-category="kebaya">
                    <a href="detail.php" class="text-dark text-decoration-none"><img src="assets/images/2.png" alt="Product Image" class="img-fluid"></a>
                    <h5 class="mt-2">Kebaya Modern</h5>
                    <p><span class="product-price">Rp. 150,000</span></p>
                </div>
            </div>
        </div>
    </section>
