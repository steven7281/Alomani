...
<body>
                            ...
                            <table class="table">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td><button class="btn btn-sm btn-info">Tambah</button></td>
                                    </tr>
                                    <tr>
                                        <td>PRD002</td>
                                        <td>Batik Alomani Red XXL</td>
    ...
    <script>
        ...
        function showSection(section) {
            const sections = ['dashboard', 'orders', 'products', 'stock', 'reports', 'settings'];
            sections.forEach(s => {
            ...
            new Chart(ctx, {
                ...
                data: {
                    ...
                    datasets: [{
                        ...
                        data: [3500000, 4200000, 3800000, 4000000],
                        borderColor: '#814603',
                        tension: 0.1
                    }]
                },
