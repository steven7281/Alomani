            ...
            <div class="row g-4">
                <div class="col-6 col-lg-3">
                    <div class="card h-100">
                        <img src="assets/images/6.png" class="card-img-top" alt="Kebaya Bali">
                        <div class="card-body text-center">
                            <h5 class="card-title">Kebaya Bali</h5>
            ...
            <div class="categories-container">
                <div class="category-item">
                    <a href="new.php" class="text-decoration-none">
                        <img src="assets/images/1.png" alt="TERBARU" class="category-img">
                ...
                <div class="category-item">
                    <a href="wanita.php" class="text-decoration-none">
                        <img src="assets/images/4.png" alt="Wanita" class="category-img">
                        <div class="category-text">
                            <p>Shop</p>
                            <h2>Wanita</h2>
                        </div>
