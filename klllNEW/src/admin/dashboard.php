...
$query_pesanan = mysqli_query($conn, "SELECT * FROM tb_order WHERE status_pembayaran = 'berhasil'");

echo "Jumlah pesanan dengan pembayaran berhasil: " . mysqli_num_rows($query_pesanan);
